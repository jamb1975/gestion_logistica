...
import org.gestionlogistica.gateways.GlMaritimaUseCaseRepository;
import org.gestionlogistica.model.GlClient;
import org.springframework.web.reactive.function.server.ServerRequest;
import org.springframework.web.reactive.function.server.ServerResponse;
import reactor.core.publisher.Mono;

public class GlMaritimaUseCase implements GlMaritimaUseCaseRepository {

    private final GlClientAdapterRepository glClientRepository;

    public GlMaritimaUseCase(GlClientAdapterRepository glClientRepository){
